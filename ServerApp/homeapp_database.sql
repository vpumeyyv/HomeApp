...
insert into substances (code, description) values('co','carbon monoxide');
insert into substances (code, description) values('co2','carbon dioxide');
insert into substances (code, description) values('nox','nitrous oxide');
